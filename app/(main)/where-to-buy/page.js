...
export default function WhereToBuy() {
  ...
  return (
    ...
    <div className="secondary-bg py-50 bg-contain bg-center text-center relative before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[#00000010]">
      <h2 className="relative z-10 text-2xl md:text-5xl opacity-50 tracking-[15px] font-bold text-[#461e04] mx-2 text-center py-3 md:py-8 uppercase">Where to buy</h2>
        ...
        <div className='relative z-10 mt-10 grid grid-cols-3 px-10 py-20 gap-10'>
            {shops && shops.map((shop) => (
                <Link href={shop.href} target="_blank" key={shop.name} className="bg-[#fefcf9] transition-all duration-500 hover:bg-yellow-300 rounded-md py-5 px-8 shadow-lg col-span-3 md:col-span-1 text-center">
                    <img src={shop.src} className="mb-5 mx-auto" loading="lazy" alt={shop.name}/>
