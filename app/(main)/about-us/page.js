  ...
  return (
    <div className="secondary-bg py-50 bg-contain bg-center relative before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[#00000010]">
      ...
      <div className="relative z-10 grid grid-cols-4 mt-10 mx-auto w-[90%] gap-5">
        ...
        <div className="hidden lg:block col-span-4 lg:col-span-2 shadow-xl">
            <img src="/assets/imgs/about-sec-2.webp" className="rounded-sm" loading="lazy" alt="ElShamadan Journey"/>
        </div>
        <div className="col-span-4 lg:col-span-2 py-8 w-[90%] lg:w-[70%] mx-auto">
