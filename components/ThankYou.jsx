...
export default function ThankYou({ userName }) {
  ...
  return (
    <main className="py-50 text-center px-5 absolute w-full h-full top-0 lef-0 flex justify-center items-center flex-col">
        ...
        <Link href='/' aria-label="Go To Home Page" className='btn shadow-sm px-8 text-base border-none font-semibold rounded-2xl transition-all duration-700 bg-yellow-300 hover:bg-[#461e04] text-[#461e04] hover:text-[#fefcf9] hover:px-12'>Back Home</Link>
    </main>
  )
}
