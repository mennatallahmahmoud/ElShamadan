        ...
        viewport={{ once: true, amount: 0.2 }}>
          ...
          <div className="card-body items-center text-center">
            ...
            <div className="card-actions">
              <Link href={`/products/${cat.product}`} aria-label="Go To Product Page" className="btn shadow-sm px-8 relative z-20 border-none font-semibold rounded-3xl transition-all duration-700 bg-[#ffd112] text-[#461e04] mt-3 hover:text-white hover:bg-[#461e04] hover:px-12">Discover</Link>
            </div>
          </div>
        </motion.div>
        ))}
