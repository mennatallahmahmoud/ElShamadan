...
export default function CouponSec() {
  ...
  return (
    <main id="coupon-sec" className="coupon-sec bg-cover bg-center p-8 md:p-20 min-h-[400px] flex justify-center items-center relative before:absolute before:w-full before:h-full before:top-0 before:left-0 before:bg-[#0000005b]">
